    ...
    <footer className="">
      ...
      <div className="bg-neutral-700">
        <div className="inner--section">
          <div className="flex flex-col gap-15 lg:gap-25 py-8">
              ...
              <div className=" flex flex-col lg:flex-row  gap-8 lg:gap-16">
                ...
                <div className="footer--text w-[50%] space-y-2 lg:space-y-4">
                  ...
                  <ul className="space-y-1 lg:space-y-2">
                    <li>
                      Fortune Sealing Equipments Trading LLC, AM Facility,
                      Office No.31,M4 Musaffah Abu Dhabi U.A.E
                    </li>
            ...
            <div className="footer--text flex flex-col lg:flex-row lg:justify-between gap-4">
              ...
              <div className="text-[.8rem] lg:text-[.9rem] self-end">
                &copy; {new Date().getFullYear()} Fortune Sealing | Privacy
                Policy |{" "}
                <Link
