  ...
  return (
    <section>
      <div className="pt-[4.5rem] lg:pt-[6rem] space-y-6 lg:space-y-6">
        <div className="w-[95%] lg:w-[85%] mx-auto flex flex-col gap-1 md:gap-2 lg:flex-row justify-between lg:items-end">
        ...
        <div className="bg-[#fafcfb] h-[12rem] md:h-[18rem] lg:h-[22rem] relative">
          <Swiper
            modules={[Autoplay]}
            slidesPerView={1}
            autoplay={{ delay: 3000 }}
