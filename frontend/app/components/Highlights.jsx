    ...
    <section className="section--secondary">
      <div className="inner--section">
        ...
        <div className="section--right relative grid grid-cols-2 gap-50">
          <div className="absolute w-px top-0 bottom-0 left-1/2 bg-black/25"></div>

          <div className="flex flex-col">
            {highlights.slice(0, 2).map((data) => (
              <div key={data.id} className="flex gap-4 py-15 first:pt-0">
          ...
          <div className="flex flex-col">
            {highlights.slice(2).map((data) => (
              <div key={data.id} className="flex gap-4 py-15 last:pb-0">
